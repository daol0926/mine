...
var Sprite = function () {
    ...
    return _createClass(t, [{
      key: "spriteAni",
      value: function () {
        if (this.timestamp += 1, this.index >= this.totalPlayCount)
          if (this.currentPlayCount++, this.loop) this.reset();
          else {
      ...
      key: "changePosition",
      value: function () {
        this.clearCanvas(), this.Object.drawImage({
          x: -this.width * (this.index + this.startIndex)
        })
      }
    }, {
      key: "changeImage",
      value: function () {
        this.clearCanvas(), this.Object.drawImage({
          img: this.Object.images[this.index + this.startIndex]
        })
      }
    }, {
      key: "reset",
    ...
    return _createClass(t, [{
      ...
      value: function () {
        for (var t = this, i = 0, s = 1; s < this.length + 1; s++) {
          ...
          e.src = this.DATA.src + this.DATA.name + a + this.DATA.fileType, this.images.push(e), e.onload = function () {
            i++, i === t.length && (t.drawImage({
              img: t.images[t.DATA.index ? t.DATA.index - 1 : 0]
      ...
      value: function (t) {
        var i = t.img,
          ...
          n = void 0 === a ? 0 : a,
          h = t.width,
          o = void 0 === h ? this.width : h,
          l = t.height,
          c = void 0 === l ? this.height : l,
